...
Route::middleware(['auth', 'active', 'force.password'])->group(function () {
    ...
    Route::middleware(['permission:admissions.view'])->name('admissions.')->group(function () {
        ...
        Route::middleware(['permission:admissions.create'])->group(function () {
            ...
            Route::put('admissions/applications/{application}/parents/{guardian}', [ApplicationGuardianController::class, 'update'])->name('parents.update');
            Route::delete('admissions/applications/{application}/parents/{guardian}', [ApplicationGuardianController::class, 'destroy'])->name('parents.destroy');
